...
class BolMartSearcher(BaseSearcher):
    marketplace_name = "BolMart.az"
    marketplace_emoji = "🛒"
    is_local = True
    ...
    async def search(self, query: str, barcode: Optional[str] = None) -> list[SearchResult]:
        ...
        try:
            async with aiohttp.ClientSession() as session:
                search_url = f"https://bolmart.az/az/search?q={query}"
                headers = {
