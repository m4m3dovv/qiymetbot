"""
Bravo Supermarket (bravo.supermarket) searcher
Major Azerbaijan supermarket chain
"""
...
class BravoSearcher(BaseSearcher):
    marketplace_name = "Bravo Supermarket"
    marketplace_emoji = "🛒"
    is_local = True
    ...
    async def search(self, query: str, barcode: Optional[str] = None) -> list[SearchResult]:
        ...
        try:
            async with aiohttp.ClientSession() as session:
                search_url = f"https://bravo.az/az/search?q={query}"
                headers = {
