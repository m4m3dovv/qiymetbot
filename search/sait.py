"""
Sait.az searcher
Azerbaijan product price comparison platform
"""
...
class SaitSearcher(BaseSearcher):
    marketplace_name = "Sait.az"
    marketplace_emoji = "🔍"
    is_local = True
    ...
    async def search(self, query: str, barcode: Optional[str] = None) -> list[SearchResult]:
        ...
        try:
            async with aiohttp.ClientSession() as session:
                search_url = f"https://sait.az/az/search?q={query}"
                headers = {
